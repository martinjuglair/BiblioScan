  ...
  return (
    <div className="px-3 sm:px-4 py-4">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-xl sm:text-2xl font-bold text-text-primary">Groupes</h1>
        <button
      ...
      {groups.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h2 className="text-lg font-bold text-text-primary mb-2">Rejoignez un groupe de lecture</h2>
          <p className="text-sm text-text-tertiary mb-6 max-w-xs mx-auto">
            Créez un groupe pour partager vos lectures, vos avis et vos recommandations avec d'autres lecteurs.
          </p>
      ...
      <BottomSheet isOpen={showActions} onClose={() => setShowActions(false)} title="Que souhaitez-vous faire ?">
        <div className="space-y-1 pb-4">
          ...
          >
            ...
            <div>
              <p className="font-semibold text-sm text-text-primary">Créer un groupe</p>
