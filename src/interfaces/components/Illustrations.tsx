 ...
 * Bubblegum palette: Grape #8B5CF6, Bubblegum #F472B6, Mint #34D399, Lemon #FBBF24, Sky #38BDF8
 */
...
export function BookStackIllustration({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Bottom book */}
      <rect x="20" y="72" width="80" height="16" rx="3" fill="#8B5CF6" opacity="0.9" />
      <rect x="24" y="76" width="30" height="3" rx="1.5" fill="white" opacity="0.6" />
      {/* Middle book */}
      <rect x="15" y="52" width="85" height="16" rx="3" fill="#F472B6" opacity="0.85" transform="rotate(-3 57 60)" />
      ...
      {/* Bookmark */}
      <path d="M75 28V15a2 2 0 014 0v13l-2-2-2 2z" fill="#F472B6" />
      {/* Sparkles */}
      <circle cx="95" cy="25" r="2.5" fill="#FBBF24" opacity="0.7" />
      <circle cx="100" cy="35" r="1.5" fill="#8B5CF6" opacity="0.5" />
...
export function WishlistIllustration({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Open book */}
      <path d="M20 85V35c0-2 1-4 3-4h30c5 0 7 3 7 3s2-3 7-3h30c2 0 3 2 3 4v50" stroke="#8B5CF6" strokeWidth="2.5" fill="none" />
      <path d="M60 34v51" stroke="#A78BFA" strokeWidth="1.5" opacity="0.5" />
      {/* Lines on left page */}
      ...
      {/* Heart */}
      <path d="M72 48c0-4 3-7 6.5-7S85 44 85 48c0 0 0 0 0 0 0 4-6.5 10-6.5 10S72 52 72 48z" fill="#F472B6" opacity="0.8" />
      <path d="M85 48c0-4 3-7 6.5-7S98 44 98 48c0 0 0 0 0 0 0 4-6.5 10-6.5 10S85 52 85 48z" fill="#F472B6" opacity="0.8" />
    </svg>
  );
}
...
export function EmptyShelfIllustration({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 160 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="20" y="84" width="3" height="20" rx="1" fill="#C4B5FD" />
      <rect x="137" y="84" width="3" height="20" rx="1" fill="#C4B5FD" />
      {/* Single leaning book */}
      <rect x="65" y="45" width="14" height="35" rx="2" fill="#8B5CF6" opacity="0.8" transform="rotate(-8 72 62)" />
      ...
      <circle cx="95" cy="75" r="1" fill="#F472B6" opacity="0.3" />
...
export function ScanIllustration({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Phone outline */}
      <rect x="35" y="15" width="50" height="90" rx="8" stroke="#C4B5FD" strokeWidth="2" fill="white" />
      {/* Screen */}
      ...
      {/* Scan line */}
      <rect x="44" y="50" width="32" height="2" rx="1" fill="#8B5CF6" opacity="0.8" />
      {/* Sparkle */}
...
export function StatsIllustration({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Bars */}
      <rect x="20" y="60" width="16" height="40" rx="3" fill="#8B5CF6" opacity="0.8" />
      <rect x="42" y="40" width="16" height="60" rx="3" fill="#F472B6" opacity="0.8" />
