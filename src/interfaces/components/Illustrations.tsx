...
export function BookStackIllustration({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Bottom book */}
      <rect x="20" y="72" width="80" height="16" rx="3" fill="#FB6538" opacity="0.9" />
      ...
      <circle cx="100" cy="35" r="1.5" fill="#FB6538" opacity="0.5" />
...
export function WishlistIllustration({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Open book */}
      <path d="M20 85V35c0-2 1-4 3-4h30c5 0 7 3 7 3s2-3 7-3h30c2 0 3 2 3 4v50" stroke="#FB6538" strokeWidth="2.5" fill="none" />
      <path d="M60 34v51" stroke="#FFAF85" strokeWidth="1.5" opacity="0.5" />
      {/* Lines on left page */}
      ...
      {/* Heart */}
      <path d="M72 48c0-4 3-7 6.5-7S85 44 85 48c0 0 0 0 0 0 0 4-6.5 10-6.5 10S72 52 72 48z" fill="#FF8B5F" opacity="0.8" />
      <path d="M85 48c0-4 3-7 6.5-7S98 44 98 48c0 0 0 0 0 0 0 4-6.5 10-6.5 10S85 52 85 48z" fill="#FF8B5F" opacity="0.8" />
    </svg>
  );
}
...
export function EmptyShelfIllustration({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 160 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Single leaning book */}
      <rect x="65" y="45" width="14" height="35" rx="2" fill="#FB6538" opacity="0.8" transform="rotate(-8 72 62)" />
      ...
      <circle cx="95" cy="75" r="1" fill="#FF8B5F" opacity="0.3" />
